...
export const buttonStyles = stylex.create({
  ...
  outline: {
    backgroundColor: { default: colors.background, ":hover": colors.surfaceSubtle },
  ...
  xs: { borderRadius: metrics.radiusMd, fontSize: "12px", height: "24px", paddingLeft: "8px", paddingRight: "8px" },
  sm: { fontSize: "13px", height: "28px", paddingLeft: "10px", paddingRight: "10px" },
  md: { height: "32px", paddingLeft: "10px", paddingRight: "10px" },
  lg: { height: "36px", paddingLeft: "12px", paddingRight: "12px" },
