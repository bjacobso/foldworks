...
| Tooltip | `Stateful.Tooltip` | Hover delay, keyboard/pointer modality, focus and Escape behavior, anchored non-interactive portal | Plain content surface; compose rich interactive content with Popover |
