...
const modules = [Agent, CodeEditor, EditorContracts, StructuredEditor, DataTable, DataGrid, FormBuilder, History, PdfAnnotator, QueryBuilder, Sidebar, Ui, UiIcon, UiTokens, Workflow];
